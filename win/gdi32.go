...
func AddFontMemResourceEx(pFileView uintptr, cjSize uint32, pvReserved unsafe.Pointer, pNumFonts *uint32) windows.Handle {
...
func CreateDIBSection(hdc HDC, pbmih *BITMAPINFOHEADER, iUsage uint32, ppvBits *unsafe.Pointer, hSection windows.Handle, dwOffset uint32) HBITMAP {
...
func RemoveFontMemResourceEx(h windows.Handle) bool {
